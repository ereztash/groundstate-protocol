    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mx-auto max-w-2xl">
          ...
          <p className="mt-5 cor-body-lg text-foreground/80">
            הסדר לא שרירותי. בלי נרטיב מחולץ, הצעת הערך תהיה גנרית. בלי הצעת ערך, המוצר ירחף. בלי מוצר ברור, הפניות לא יידעו על מה לדבר. כל שלב הוא הקרקע של הבא אחריו.
          </p>
        </Reveal>
