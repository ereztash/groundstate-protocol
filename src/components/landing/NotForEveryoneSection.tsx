      ...
      <div className="mx-auto max-w-3xl px-6">
        <Reveal className="space-y-6">
          ...
          <ul className="cor-body-lg list-none space-y-2 text-foreground/80">
            <li>את נותנת שירות בעיקר לתאגידים, לא לעצמאים.</li>
            <li>יש לך כבר 30+ לקוחות פעילים ואת רוצה לסנן.</li>
            <li>את רגילה לעבוד על תחושה ולא על מבנה, זה ירגיש מעצבן.</li>
            <li>את מחפשת חימום רגשי לפני פעולה, אני לא הכתובת.</li>
          </ul>
