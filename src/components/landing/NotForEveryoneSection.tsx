      ...
      <div className="mx-auto max-w-3xl px-6">
        <Reveal className="space-y-6">
          ...
          <ul className="cor-body-lg list-none space-y-2 text-foreground/80">
            <li>— אתם נותנים שירות בעיקר לתאגידים, לא לעצמאים.</li>
            <li>— יש לכם כבר 30+ לקוחות פעילים ואתם רוצים לסנן.</li>
            <li>— אתם רגילים לעבוד על תחושה ולא על מבנה — זה ירגיש מעצבן.</li>
            <li>— אתם מחפשים חימום רגשי לפני פעולה — אני לא הכתובת.</li>
          </ul>
